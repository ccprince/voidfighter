...
describe('Cost with weapons', () => {
  it.each([
    [Gunship({ speed: 1, weaponsBase: [{ firepower: Rating.D8, arc: WeaponArc.Front }] }), 9],
    [Gunship({ speed: 1, weaponsBase: [{ firepower: Rating.D8, arc: WeaponArc.Turret }] }), 9],
    [Gunship({ speed: 1, weaponsBase: [{ firepower: Rating.D8, arc: WeaponArc.EnhancedTurret }] }), 10],
    [Corvette({ weaponsBase: [{ firepower: Rating.D10, arc: WeaponArc.Front }, { firepower: Rating.D8, arc: WeaponArc.Rear }, { firepower: Rating.D8, arc: WeaponArc.EnhancedTurret }] }), 24],
  ])('%o -> %d', (ship, expected) => {
